...
public class WeekDayView extends View {
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#EFF1F3");
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#EFF1F3");
    //周一到周五的颜色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (appLan == 0) {
            weekString = new String[]{"日", "一", "二", "三", "四", "五", "六"};
        } else {
            weekString = new String[]{"Sun", "Mon", "Tues", "Wed", "Thur", "Fri", "Sat"};
        }
        ...
        for (int i = 0; i < weekString.length; i++) {
            ...
            int appLan1 = Utils.GetSystemCurrentVersion();
            if (appLan1 == 0) {
